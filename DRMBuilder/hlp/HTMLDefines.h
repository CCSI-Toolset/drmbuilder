...
#define HID_SETUP_ACMMODEL                      0x18003
#define HID_SETUP_INPUTPARAMETERS               0x18004
#define HID_SETUP_OUTPUTVARIABLES               0x18005
#define HID_SETUP_INPUTSAMPLLING                0x18006
#define HID_SETUP_INPUTVARIABLES                0x18007
#define HID_SETUP_PREPAREIDENTIFICATION         0x18008
#define HID_BUILD_LAUNCHHIGH                    0x18009
#define HID_BUILD_BUILDREDUCEDMODEL             0x1800A
#define HID_Menu                                0x1800B
#define HID_SETUP_PREPAREVALIDATIONSEQUENCE     0x1800C
#define HID_SETUP_PREPARE_TRAINING_SEQUENCE     0x1800D
#define HID_SETUP_PREPARE_VALIDATION_SEQUENCE   0x1800E
#define HID_BUILD_SHOWTRAININGRESULTS           0x1800F
#define HID_BUILD_SHOWVALIDATIONRESULTS         0x18010
#define HID_BUILD_LAUNCH_SIMULATION             0x18011
#define HID_BUILD_GENERATE_REDUCED_MODEL        0x18012
#define HID_BUILD_SHOW_TRAINING_RESULTS         0x18013
#define HID_BUILD_SHOW_VALIDATION_RESULTS       0x18014
#define HID_FILE_EXPORTD                        0x18015
#define HID_SETUP_CHOOSEHIGH                    0x18016
#define HID_CHOOSEHIGH_ACM                      0x18017
#define HID_CHOOSEHIGH_GPROMS                   0x18018
#define HID_SETUP_CHOOSE_ACM                    0x18019
#define HID_SETUP_CHOOSE_GPROMS                 0x1801A
#define HID_BUILD_LAUNCH_TRAINING_SIMULATION    0x1801B
#define HID_BUILD_LAUNCHVALIDATIONSIMULATION    0x1801C
#define HID_BUILD_LAUNCH_VALIDATION_SIMULATION  0x1801D
#define HID_CHOOSEHIGH_DML                      0x1801E
#define HID_SETUP_CHOOSE_DML                    0x1801F
#define HID_CHOOSEHIGH_MATLABSCRIPTFILE         0x18020
#define HID_SETUP_CHOOSE_MATLAB                 0x18021
#define HID_BUILD_PREDICT_TRAINING_DATA         0x18022
#define HID_BUILD_PREDICT_TRAINING_RESPONSE     0x18023
#define HID_BUILD_PREDICT_VALIDATION_RESPONSE   0x18024
#define HID_POSTPROCESS_PREDICT                 0x18025
#define HID_POSTPROCESS_PREDICTVALIDATIONRESPONSE	0x18026
#define HID_POSTPROCESS_COMPARE                 0x18027
#define HID_POSTPROCESS_COMPARE32808            0x18028
#define HID_POSTPROCESS_PREDICT_TRAINING        0x18029
#define HID_POSTPROCESS_PREDICT_VALIDATION      0x1802A
#define HID_POSTPROCESS_COMPARE_TRAINING        0x1802B
#define HID_POSTPROCESS_COMPARE_VALIDATION      0x1802C
#define HID_VIEW_SCROLLTOBOTTOM                 0x1802D
#define HID_FILE_EXPORT_DRM                     0x1802E
#define HID_POSTPROCESS_USEBALANCEDMODEL        0x1802F
#define HID_BUILD_USEIPOPTFORANNTRAINING        0x18030
#define HID_BUILD_SCALELAGUERREANNINPUTS        0x18031
#define HID_BUILD_SCALEBALANCEDANNINPUTS        0x18032
#define HID_BUILD_USEIPOPTFORBALANCEDANNTRAINING	0x18033
#define HID_FILE_EXPORTLAGUERREWEIGHTMATRICES   0x18034
#define HID_BUILD_D                             0x18035
#define HID_D_DABNET                            0x18036
#define HID_D_NARMA                             0x18037
#define HID_CHOOSEHIGH_ACMSNAPSHOTFILE          0x18038
#define HID_FILE_EXPORTLO                       0x18049
#define HID_FILE_EXPORTLOG                      0x1804A
#define HID_FILE_EXPORT_LOG                     0x1804B
#define HID_FILE_EXPORTTRAININGDATA             0x1804C
#define HID_FILE_EXPORTVALIDATIONDATA           0x1804D
#define HID_FILE_EXPORTACMFILE                  0x1804E
#define HID_FILE_EXPORT                         0x1804F
#define HID_FILE_EXPORT32848                    0x18050
#define HID_EXPORT_ACMFILE                      0x18051
#define HID_EXPORT_ACMSNAP                      0x18052
#define HID_EXPORT_SIMULINKFILE                 0x18053
#define HID_EXPORT_TRAININGDATA                 0x18054
#define HID_EXPORT_VALIDATIONDATA               0x18055
#define HID_EXPORT_D                            0x18056
#define HID_EXPORT_LOGFILE                      0x18057
#define HID_FILE_EXPORT_ACMSNAP                 0x18058
#define HID_FILE_EXPORTACMSNAPSHOTFILE          0x18059
#define HID_FILE_EXPORTSIMULINKFILE             0x1805A
#define HID_POST_USEHIGH                        0x1805B
#define HID_POSTPROCESS_USEHIGHFIDELITYHISTORY  0x1805C
#define HID_UQ_SETNOISE                         0x1805D
#define HID_UQ_CALCULATE                        0x1805E
#define HID_EXPORT_COVARIANCEMATRICES           0x1805F
...
#define HIDR_DRMBuilderTYPE                     0x20081
 
// Dialogs (IDD_*) 
#define HIDD_ABOUTBOX                           0x20064
#define HIDD_DIALOG_INPUT_VARIABLE              0x20082
#define HIDD_DIALOG_OUTPUT_VARIABLE             0x20083
#define HIDD_DIALOG_SOLVER_INPUT                0x20084
#define HIDD_DIALOG_MODEL_PARAMETER             0x20085
#define HIDD_DIALOG_MODEL_PARAMETER_NARMA       0x20086
#define HIDD_DIALOG_PLOT_RESULT                 0x20087
#define HIDD_DIALOG_ACM_PATHNAME                0x20088
#define HIDD_DIALOG_NOISE                       0x2008A
